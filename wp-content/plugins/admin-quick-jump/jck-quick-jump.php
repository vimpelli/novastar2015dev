...
/**
* @package JCK_Quick_Jump
* @version 1.4
*/

/*
Plugin Name: Admin Quick Jump
...
class jck_aqj
{
  ...
  function list_posts()
  {
    ...
    $jck_posts = $wpdb->get_results("SELECT ID, post_title FROM $wpdb->posts WHERE $wpdb->posts.post_parent = 0  AND $wpdb->posts.post_type = '$posttype' AND $wpdb->posts.post_status = 'publish' ORDER BY post_title ASC");    
